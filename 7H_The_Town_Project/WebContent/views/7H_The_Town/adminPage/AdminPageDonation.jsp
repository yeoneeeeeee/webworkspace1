                            ...
                            <table class="highlight">
                                <thead>
                                    <tr>
                                        ...
                                        <td style="width:27%; text-align: center;">회원번호</td>
                                        <td style="width:29%; text-align: center;">후원종류</td>
                                        <td style="width:17%; text-align: center;">후원금액</td>
                                        <td style="width:17%; text-align: center;">후원날짜</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>

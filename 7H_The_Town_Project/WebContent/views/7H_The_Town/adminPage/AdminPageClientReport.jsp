                ...
                <div class="board-wrap">
                    ...
                    <div class="category-list">
                        <li><button class="waves-effect waves-light"><a
                                    href="/7HTheTown/7HTHETOWN_AdminPage_ClientCenter.html">문의
                                    내용</a></button></li>
                        <li><button class="waves-effect waves-light" style="background-color: rgb(255, 216, 144);"><a
                                    href="/7HTheTown/7HTHETOWN_AdminPage_ClientReport.html">신고 내역</a></button></li>
                    </div>
                </div>

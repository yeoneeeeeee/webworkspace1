...
<body>
    ...
    <div class="main_title_wrap">
        <h2 class="main_tlt_txt">입양후기 게시판</h2>
    </div>
	<div class="board_wrap">
        <div class="board_top_list">
            <li ><a href="/PostionPage_None.html">공지사항 및 이벤트</a></li>
            <li ><a href="/PostionPage_board.html">일반게시판</a></li>
            <li><a href="/PostionPage_Sharing.html">나눔 게시판</a></li>
            <li style="background-color: orange;"><a href="/PostionPage_Adopted.html">입양후기 게시판</a></li>
        </div>

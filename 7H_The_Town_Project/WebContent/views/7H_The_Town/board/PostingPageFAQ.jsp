...
<body>
    ...
    <div class="main_posting_wrap">
        <h2 class="posting_title">1 : 1 상담</h2>
        <form>
            <div class="category_head">
                <div class="category_title"><input type="text" name="title" placeholder="제목" required style="height: 60px;"></div>
            </div>
            ...
            <button type="submit" align="center" class="category_sumt">등록하기</button>
        </form>

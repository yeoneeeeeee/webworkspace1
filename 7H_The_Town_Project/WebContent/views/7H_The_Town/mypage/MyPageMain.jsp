...
<head>
    ...
    <link rel="stylesheet" href="views/7H_The_Town/resource/CSS,JS/mypage/MyPageMain.css">
        ...
        <div class="main-container">
            ...
            <div class="mypage-content">
                ...
                <div class="user-info user-info1 box">
                    ...
                    <div class="grade-txt">
                        <div class="txt txt1">
                            <span>OOO회원님의</span><br>
                            <span>투게더 등급은 ㅁㅁㅁ입니다.</span>
                        </div>
                        <br>
                        <div class="txt txt2">
                ...
                <div class="user-info user-info2">
                    <div class="user-count box">
                        <div class="count-wrap">
                            <div class="flex-box">
                                <div class="img-box">
                                    <img src="views/7H_The_Town/resource/img/7H_THE_TOWN_LOGO.png" width="70px"
                                        height="70px" />
                                </div>
                                <div class="txt-box">
                                    <span>누적 후원</span>
                    ...
                    <div class="user-deli box">
                        <div class="deli-img">
                            <img src="views/7H_The_Town/resource/img/7H_THE_TOWN_LOGO.png" width="250px"
                                height="250px" />
                        </div>
                        <div class="deli-txt">
                            <span>배송현황</span>
                    ...
                    <div class="info3-wrap">
                        <div class="user-email">
                            ...
                            <div class="email-txt2">
                                <span>EMAIL_ID | ckdwjd2717@naver.com</span>
                            </div>
                        </div>
                        <hr>
                        <div class="user-address">
                            ...
                            <div class="address-txt2">
                                <span>배송지 | 서울특별시 강남구 테헤란로14길 6 남도빌딩</span>
                            </div>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <link rel="stylesheet" href="views/7H_The_Town/resource/CSS,JS/mypage/MyPageInquiry.css">
        ...
        <div class="container">
            <div class="sidebar box">
                ...
                <dl class="side-navi">
                    ...
                    <dt>
                        <a href="/7HTheTown/7HTHETOWN_MyPage_Like.html">최애의 아이</a>
                    </dt>
                    <dt>
                ...
                <div class="mypage-content">
                    ...
                    <div class="user-info2 box">
                        <div class="info2-wrap">
                            ...
                            <div class="btn-wrap">
                                <a class="waves-effect waves-light btn">문의 삭제</a>
                            </div>
                        </div>
                    </div>
                </div>
